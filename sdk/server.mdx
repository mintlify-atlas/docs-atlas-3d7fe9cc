---
title: "createOpencodeServer: Spawn and Manage a Shob Server"
sidebarTitle: "Server"
description: "createOpencodeServer spawns and manages a Shob server child process from Node.js or Bun. Returns the server URL and a close() function."
---
