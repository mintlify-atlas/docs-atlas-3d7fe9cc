---
title: "OpencodeClient: Typed REST API Client for Shob SDK"
sidebarTitle: "Client"
description: "createOpencodeClient returns a typed REST API client for a running Shob server. Covers sessions, providers, tools, MCP, file operations, and events."
---
