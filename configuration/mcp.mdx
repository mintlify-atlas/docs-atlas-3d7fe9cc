---
title: "Configure MCP Servers in Shob"
sidebarTitle: "MCP Servers"
description: "Add local and remote Model Context Protocol servers to Shob via shob.json or the interactive CLI. Supports stdio, local, and remote server types."
---
