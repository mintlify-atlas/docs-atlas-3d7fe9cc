---
title: "Configuring Shob with shob.json"
sidebarTitle: "Overview"
description: "Shob is configured via shob.json or shob.jsonc files at global and project scopes. Learn the config schema, precedence rules, and environment variable overrides."
---
...
| `keybindings` | `object` | TUI keybinding overrides |
