---
title: "Configure AI Providers in Shob: API Keys and Models"
sidebarTitle: "Providers"
description: "Configure Anthropic, OpenAI, and OpenAI-compatible providers in shob.json. Set API keys, base URLs, model allowlists, and default models."
---
