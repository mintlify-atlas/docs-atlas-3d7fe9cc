---
title: "shob agent — Create and List Custom Agents"
sidebarTitle: "agent"
description: "shob agent manages custom AI agents. Subcommands: create, list. Create agents with specific models, tools, and permission rules."
---
