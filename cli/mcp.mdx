---
title: "shob mcp — Add, List, and Authenticate MCP Servers"
sidebarTitle: "mcp"
description: "shob mcp manages Model Context Protocol servers. Subcommands: add, list (ls alias), auth with auth list (ls alias), logout, and debug."
---
