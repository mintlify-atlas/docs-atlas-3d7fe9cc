---
title: "Shob CLI Reference — Commands, Flags, and Examples"
sidebarTitle: "Overview"
description: "Complete reference for the Shob CLI. Lists every top-level command, all global flags, and common usage patterns for the shob binary."
---
