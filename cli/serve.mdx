---
title: "shob serve — Start a Persistent Headless HTTP Server"
sidebarTitle: "serve"
description: "shob serve starts Shob as a persistent, headless HTTP server. Use --port, --hostname, --mdns, --mdns-domain, and --cors to configure it."
---
