---
title: "Shob Plugin Hooks: Complete Reference for All Hook Types"
sidebarTitle: "Hooks"
description: "Complete reference for all Shob plugin hooks. Covers event, config, auth, provider, chat.message, chat.params, permission.ask, and shell.env hooks."
---
