---
title: "Shob Plugin System: Extend Agent Capabilities"
...
Plugins are listed in your project's `shob.json` under the `"plugins"` key. Each entry is either a package name or a two-element tuple `[packageName, optionsObject]`:
