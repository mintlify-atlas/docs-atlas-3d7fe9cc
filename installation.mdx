---
title: "Install Shob CLI on macOS, Linux, and Windows"
sidebarTitle: "Installation"
description: "Install the Shob CLI using npm, bun, or pnpm. Covers macOS, Linux, and Windows with system requirements and upgrade instructions."
---
...
<Tip>
  If `shob upgrade` cannot detect your package manager it will prompt you to select one manually. You can also pass `--method npm`, `--method pnpm`, `--method bun`, or `--method brew` to skip the prompt.
</Tip>
