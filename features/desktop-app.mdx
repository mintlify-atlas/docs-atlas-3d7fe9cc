...
description: "The Shob desktop app is an Electron-based GUI with a file tree, integrated terminal, diff viewer, and multi-tab session management for AI-assisted development."
---
...
The desktop app ships with **35 built-in color themes**, selectable from Settings. Themes affect the editor, terminal, diff viewer, and UI chrome.
